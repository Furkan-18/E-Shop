...
using E_Shop.WebUI.Areas.Admin.Models;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Diagnostics.Eventing.Reader;

namespace E_Shop.WebUI.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        var viewModel = listCategoryDtos.Select(x => new CategoryListViewModel
        {
            Id = x.Id,
            Name = x.Name,
            Summary = x.Description is not null && x.Description.Length > 20 ?
            x.Description.Substring(0, 20) + "..." : x.Description
        }).ToList();
...
return View("form", viewModel);
        ...
        public IActionResult Save(CategoryFormViewModel formData)
        {
            ...
            var result = _categoryService.AddCategory(addCategoryDto);
                ...
                {
                    ViewBag.ErrorMessage = "Bu isimde bir kategori zaten var";
                    return View("Form", formData);
                }
